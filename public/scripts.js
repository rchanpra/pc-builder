...
window.onload = function() {
    ...
    document.getElementById("loginPageButton").addEventListener("click", loadLogin);
    document.getElementById("registerPageButton").addEventListener("click", loadRegister);
